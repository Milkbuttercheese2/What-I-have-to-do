...
![version](https://img.shields.io/badge/version-v3.6.5-2a7c6e?style=for-the-badge)
...
1. [`최종 프로그램 산출물/`](./최종%20프로그램%20산출물) 에서 `뭐하려 했더라v3.6.5.exe` 를 받습니다.
...
| 문서 | 무엇 |
|---|---|
| [`뭐하려 했더라 사용설명서.pdf`](./뭐하려%20했더라%20사용설명서.pdf) | **처음 쓰는 분용** — 상황별("이럴 땐 이렇게") 사용법·화면 그림·FAQ |
