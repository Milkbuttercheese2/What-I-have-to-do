...
<section class="cover"><div><p class="eyebrow">PERSONAL WORK BOARD · USER GUIDE</p><h1>뭐하려 했더라</h1><p class="lead">떠오른 일을 일단 던져 두면, 시각을 따라 오늘 할 일을 알아서 올려 주는 개인 업무 보드</p></div><div class="feature-cards"><div class="feature-card"><strong>놓치는 일을 줄이려고</strong><span>떠오른 일을 완벽히 정리할 때까지 기다리지 않고, 바로 남길 수 있도록 만들었습니다.</span></div><div class="feature-card"><strong>오늘 할 일을 다시 묻지 않으려고</strong><span>마감과 점검 시각을 기준으로, 지금 처리할 일을 자연스럽게 앞에 보여 줍니다.</span></div><div class="feature-card"><strong>요청의 맥락을 잃지 않으려고</strong><span>사람·세부 할 일·파일을 함께 남겨, 나중에 찾을 때도 업무의 흐름을 이어 줍니다.</span></div></div><p class="meta">사용 설명서 · 오프라인 사용 가능 · 설치·계정 불필요</p></section>
